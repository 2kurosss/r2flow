...
function StadiumNode({
  ...
  return (
    <div
      onDoubleClick={() => startEdit(id)}
      className={`flex h-10 w-24 flex-col items-center justify-center gap-0 rounded-lg border-2 bg-card px-2 shadow-md shadow-primary/20 ${
...
export default function R2FlowNode({ id, data, selected }: NodeProps<R2FlowNode>) {
