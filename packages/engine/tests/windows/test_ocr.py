"""Tests for r2flow.windows.tools.ocr — Windows OCR tool."""
...
from r2flow.windows.tools import ocr as ocr_module
...
class TestOcrExecution:
    ...
    async def test_reads_text_from_file(
        ...
        assert captured["env"]["R2FLOW_OCR_PATH"] == str(image)
        assert captured["env"]["R2FLOW_OCR_LANG"] == ""
    ...
    async def test_language_forwarded(
        ...
        assert captured["env"]["R2FLOW_OCR_LANG"] == "ru-RU"
