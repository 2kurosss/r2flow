"""Tests for r2flow.windows.tools.keyboard — normalize_keys."""

import pytest

from r2flow.windows.tools import keyboard
from r2flow.windows.tools.keyboard import normalize_keys
