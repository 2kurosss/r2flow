...
from r2flow.core.errors import ElementNotFound, InvalidInput, PlatformError
from r2flow.windows.selector import ElementSelector
...
class TestClickExtended:
    ...
    async def test_coordinate_click_calls_helper(self) -> None:
        ...
        with patch("r2flow.windows.tools.click._click_at", return_value=None) as click_at:
    ...
    async def test_element_click_calls_helper(self) -> None:
        ...
        with (
            patch(
                "r2flow.windows.tools.click.resolve_element",
                new=AsyncMock(return_value=el),
            ),
            patch("r2flow.windows.tools.click._click_element", return_value=None) as click_el,
        ):
    ...
    def test_click_at_branches(self) -> None:
        ...
        from r2flow.windows.tools.click import _click_at, _click_element
...
class TestScroll:
    ...
    async def test_scroll_down_default(self) -> None:
        ...
        with (
            patch(
                "r2flow.windows.tools.scroll.resolve_point",
                new=AsyncMock(return_value=None),
            ),
            patch("r2flow.windows.tools.scroll._scroll_at", return_value=None) as at,
        ):
    ...
    def test_scroll_at_branches(self) -> None:
        ...
        from r2flow.windows.tools.scroll import _scroll_at
...
class TestHover:
    ...
    async def test_hover_moves(self) -> None:
        ...
        with (
            patch(
                "r2flow.windows.tools.hover.resolve_point",
                new=AsyncMock(return_value=(7, 8)),
            ),
            patch("r2flow.windows.tools.hover._move_to", return_value=None) as move,
        ):
...
class TestGetText:
    ...
    async def test_reads_value_pattern(self) -> None:
        ...
        el = _element()
        with patch(
            "r2flow.windows.tools.get_text.resolve_element",
            new=AsyncMock(return_value=el),
        ):
    ...
    def test_read_text_prefers_value_over_name(self) -> None:
        from r2flow.windows.tools.get_text import _read_text
...
class TestWindow:
    ...
    async def test_activate_calls_apply(self) -> None:
        ...
        with (
            ...
            patch("r2flow.windows.tools.window._apply_action", return_value=None) as apply,
        ):
    ...
    def test_apply_action_branches(self) -> None:
        from r2flow.windows.tools.window import _apply_action

        user32 = MagicMock()
        with patch("r2flow.windows.tools.window._user32", return_value=user32):
...
class TestSelect:
    ...
    async def test_select_calls_pattern(self) -> None:
        ...
        with patch(
            "r2flow.windows.tools.select.resolve_element",
            new=AsyncMock(return_value=el),
        ):
...
class TestDrag:
    ...
    async def test_drag_both_endpoints(self) -> None:
        from r2flow.windows.tools import drag as drag_mod
        ...
        with (
            ...
            patch("r2flow.windows.tools.drag._drag_drop", return_value=None) as dd,
        ):
    ...
    def test_drag_drop_calls_auto(self) -> None:
        ...
        from r2flow.windows.tools.drag import _drag_drop
...
class TestClipboard:
    ...
    async def test_get_returns_text(self) -> None:
        from r2flow.windows.tools import clipboard as cb_mod
...
class TestListElements:
    ...
    async def test_lists_children(self) -> None:
        ...
        with patch(
            "r2flow.windows.tools.list_elements.resolve_element",
...
class TestHighlight:
    ...
    async def test_highlight_flashes(self) -> None:
        ...
        with (
            patch(
                "r2flow.windows.tools.highlight.resolve_element",
                new=AsyncMock(return_value=el),
            ),
            patch("r2flow.windows.tools.highlight._flash_rect", return_value=None) as flash,
        ):
...
class TestFactoryAndFacade:
    ...
    async def test_facade_click_forwards_params(self) -> None:
        from r2flow.facade import R2Flow
