"""Tests for r2flow.windows.tools.get_table and control_action."""
...
class TestGetTable:
    ...
    async def test_extracts_header_and_rows(self) -> None:
        with pytest.MonkeyPatch.context() as mp:
            mp.setattr(
                "r2flow.windows.tools.get_table.resolve_element",
...
class TestControlAction:
    ...
    async def test_invoke(self) -> None:
        ...
        with pytest.MonkeyPatch.context() as mp:
            mp.setattr(
                "r2flow.windows.tools.control_action.resolve_element",
