"""Tests for r2flow.core.events — ToolEvent, EventBus, Middleware."""
...
from r2flow.core.events import EventBus, ToolEvent
...
# ---------------------------------------------------------------------------
# R2Flow middleware integration
# ---------------------------------------------------------------------------


class TestR2FlowMiddleware:
