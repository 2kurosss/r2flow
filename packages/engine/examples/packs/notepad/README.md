...
```json
{
  "schema": "r2flow-template-v1",
  "title": "Notepad demo",
  "params": [{ "name": "text", "type": "string", "default": "Hello from R2Flow!" }]
}
```
...
r2flow-run-flow --pack examples\packs\notepad --stage process --set text="Hello from R2Flow!"
...
demo list, or set `R2FLOW_ALLOWED_COMMANDS=notepad.exe,...`.

## Publish it to r2flow-cloud
