...
Public API::
    ...
    from r2flow.windows.tools.selector_capture import (
        BestSelector,
        CaptureRecord,
        PathNode,
        capture_at_point,
...
from r2flow.windows.tools.selector_capture.api import (
    CaptureCancelled,
    CapturedSelector,
    capture_once,
    capture_once_async,
...
from r2flow.windows.tools.selector_capture.record import record_series
