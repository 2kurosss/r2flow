...
from r2flow.core.redact import redact_value
from r2flow.core.transactions import current_transaction_id
    ...
    def __init__(
        ...
        *,
        ...
        self._writer = threading.Thread(
            target=self._write_loop, name="r2flow-jsonl-logger", daemon=True
        )
        self._writer.start()
