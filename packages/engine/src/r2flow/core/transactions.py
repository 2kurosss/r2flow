...
from r2flow.core.errors import BusinessError, Cancelled, InfrastructureError, InvalidInput
from r2flow.core.events import ToolEvent
from r2flow.core.queue import ClaimedItem, FinalStatus, LeaseRenewable, Queue
...
current_transaction_id: ContextVar[str | None] = ContextVar(
    "r2flow_transaction_id", default=None
)
